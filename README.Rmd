...
- Document the available package options (currently nflreadr.cache and nflreadr.prefer) somewhere.
- Maybe in `nflreadr-package.R` created with `use_package_doc()`? Or just in the readme?
