...
- Document the available package options (currently nflreadr.cache and nflreadr.prefer) somewhere. `r emo::ji("white_check_mark")`
- Maybe in `nflreadr-package.R` created with `use_package_doc()`? Or just in the readme? `r emo::ji("white_check_mark")`
