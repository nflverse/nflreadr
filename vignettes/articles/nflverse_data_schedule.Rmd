...
We are currently observing that scheduled GitHub Action workflows are experiencing significant delays (i.e., they are running much later than scheduled) or are even failing to run at all. It is therefore possible that data will be updated or added much later than this article indicates. We are working on solutions, but for now we are entirely dependent on the reliability of GitHub Actions.
...
[Injury Data](https://nflreadr.nflverse.com/articles/dictionary_injuries.html) updates every day at 7AM UTC throughout the season. 
