...
data_releases <- l |>
  ...
  dplyr::bind_rows(
    list(
      Data = "pbp_raw",
      `Last Updated` = "[![raw pbp data](https://img.shields.io/github/last-commit/nflverse/nflverse-pbp-internal?label=Raw%20PBP%20Updated&style=flat-square)]()"
    )
  )
...
[PFR Advanced Stats](https://nflreadr.nflverse.com/reference/load_pfr_advstats.html) updates every day at 0, 6, 12, 18 UTC during the season. The actual availability of new data depends on the update schedule of PFR.
